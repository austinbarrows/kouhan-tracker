...
async function generateConfigFiles() {
    try {
        ...
        await copyTemplate(path.resolve(__dirname, "templates", ".env.local.template"), path.resolve(__dirname, "..", ".env.local"));
        await copyTemplate(path.resolve(__dirname, "templates", "firebaseConfig.js.template"), path.resolve(__dirname, "..", "firebaseConfig.js"));
    } catch(e) {
        console.log(e);
